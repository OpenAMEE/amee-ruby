...
describe AMEE::Profile::Category, "with an authenticated version 2 XML connection" do
  ...
  it "should parse data items" do
    ...
    @cat.items[0][:values][:energyConsumption][:unit].should == "kW*h"
