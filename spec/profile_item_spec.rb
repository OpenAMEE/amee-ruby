...
describe AMEE::Profile::Item do
  ...
  it "should be able to create new profile items (XML)" do
    ...
    item.total_amount_per_month.should be_close(25.200, 1e-9)
  end
